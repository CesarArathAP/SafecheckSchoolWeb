...
class VerAlumno:
    ...
    def POST(self, matricula):
        ...
        if alumno:
            ...
            pdf.image('C:\Users\Juan Carlos\Desktop\INTEGRADORA/static/images/logo.png', x=10, y=10, w=33)
            # Logo en la parte derecha
            pdf.image('C:\Users\Juan Carlos\Desktop\INTEGRADORA/static/images/logo.png', x=170, y=10, w=33)
